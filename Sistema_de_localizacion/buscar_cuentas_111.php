...
<p align="center" class="style48 style49">Llamadas Predictivas </p>
<form id="form1" name="form1" method="post" action="nuevo_PU_OC_predictivo">
  <table width="1001" border="0" align="center">
    <tr>
      <td width="305"><p><span class="style4">Bienvenido: </span><span class="style4 style26"><span class="style4"><span class="style15">
          <?php /*Mostrando nombre de Usuario */echo $fila_observaciones["nombre"];?>
      </span></span></span></p></td>
      <td colspan="12"><div align="center"></div></td>
    </tr>
    <tr>
      <td height="3"><span class="style4">Eslabon:</span><span class="style15"> <strong><?php echo $_COOKIE["usuario_nombre"];?></strong></span></td>
      <td height="3" colspan="12"><div align="center" class="style4 style50">Numero de Cuenta</div></td>
    </tr>
    ...
    <tr>
      <td height="17"><div align="left"><span class="style19">Entrada</span></div></td>
	  <td height="17" colspan="12"><p align="center" class="style43">&nbsp;</p></td>
	  <?php 
    ...
    <tr>
      <td height="17"><div align="center"><span class="style43">
        <?php //echo $fila["hora"]?>
