...
<form id="form1" name="form1" method="post" action="">
  <table width="974" border="0" align="center">
    ...
    <tr>
      ...
      <td height="12" colspan="4" rowspan="2"><div align="center"><img src="imagenes/abajo.JPG" width="36" height="31" /></div></td>
      <td rowspan="2">&nbsp;</td>
      <td colspan="3" rowspan="4"><table width="455" border="0" align="center">
        <tr>
          ...
          <td width="99" bgcolor="#0066FF"><div align="center" class="style27">
              <div align="center">Cuentas Trabajadas Junio</div>
          </div></td>
          <td width="97" bgcolor="#0066FF"><div align="center"><span class="style28"><strong>Total Contactos Junio </strong></span></div></td>
        </tr>
...
<div class="resultados" id="resultados"></div></td>
    ...
    <tr>
      ...
      <td height="2"></td>
      <td height="2" colspan="4"><div align="center"><img src="imagenes/arriba.JPG" width="36" height="31" /></div></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td width="93" bgcolor="#0033FF"><div align="center" class="style27">Producto</div></td>
      <td colspan="3" bgcolor="#0033FF"><div align="center" class="style27">Saldo</div></td>
      <td width="112" bgcolor="#0033FF"><div align="center" class="style27">Mora</div></td>
      <td width="108" bgcolor="#0033FF"><div align="center" class="style27">Ciclo</div></td>
      <td width="228" bgcolor="#0033FF"><div align="center"><span class="style27">Cuenta Sucursalizada</span></div></td>
    </tr>
    <tr>
      <td colspan="3"><div align="center">
      ...
      <td><div align="center">
          <select name="sucursalizada" id="sucursalizada" onclick="checksucursalizada(this.form)" onchange="opciones_sucursalizada(this.form)" >
            <option value=" "> </option>
            <option>SI</option>
            <option>Telefonos iguales, a los enviados</option>
    ...
    <tr>
      ...
      <td width="67" bgcolor="#0066FF"><div align="center" class="style27">CR</div></td>
      <td width="44" bgcolor="#0066FF"><div align="center" class="style27">Tipo</div></td>
      <td><div align="center"></div></td>
    ...
    <tr>
      ...
      <td width="19">&nbsp;</td>
      <td width="13" bgcolor="#000099"><div align="center" class="style27">
      ...
      <td><div align="left">
          <input name="telefono_ref_1" type="text" id="telefono_ref_1"  size="15" maxlength="13" onkeypress="mis_datos()" disabled="disabled"/>
      </div></td>
    </tr>
    <tr>
      ...
      <td><div align="left">
          <input name="telefono_ref_2" type="text" id="telefono_ref_2"  size="15" maxlength="13" onkeypress="mis_datos()" disabled="disabled"/>
      </div></td>
    </tr>
    <tr>
      ...
      <td><div align="left">
          <input name="telefono_ref_3" type="text" id="telefono_ref_3"  size="15" maxlength="13" onkeypress="mis_datos()" disabled="disabled"/>
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><div align="left">
          <input name="telefono_beneficiario" type="text" id="telefono_beneficiario"  size="15" maxlength="13" onkeypress="mis_datos()" disabled="disabled"/>
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td bgcolor="#000099"><span class="style28"><strong>1-</strong></span></td>
      <td colspan="4"><label>
        <input name="domicilios_alternos_1" type="text" id="domicilios_alternos_1" size="55" disabled="disabled" />
      </label></td>
    </tr>
    <tr>
      ...
      <td>&nbsp;</td>
      <td bgcolor="#000099"><span class="style28"><strong>2-</strong></span></td>
      <td colspan="4"><label>
        <input name="domicilios_alternos_2" type="text" id="domicilios_alternos_2" size="55" disabled="disabled"/>
      </label></td>
    </tr>
    <tr>
      <td><div align="center"></div></td>
    ...
    <tr>
      <td colspan="7" bgcolor="#0000FF"><div align="center"><span class="style28"><strong>Email</strong></span></div></td>
      <td>&nbsp;</td>
      <td><div align="center"></div></td>
    ...
    <tr>
      ...
      <td><input name="hora" size="6" readonly="true" value="horaImprimible" type="hidden"/></td>
      ...
      <td><input name="base" type="hidden" id="base" value="<?php echo $fila_producto["base"]?>"/></td>
      <td>&nbsp;</td>
    </tr>
  </table>
</form>
...
if ((form1.telefono_ref_1.value.length!=0) && (form1.telefono_ref_1.disabled==false)){
			...
			alert("El Telefono de la Referencia 1, NO es valido deben ser numeros de 10 ó 13");
			form1.telefono_ref_1.focus(); return true;
			}
...
if ((form1.telefono_ref_2.value.length!=0) && (form1.telefono_ref_2.disabled==false)){
			...
			alert("El Telefono de la Referencia 2, NO es valido deben ser numeros de 10 ó 13");
