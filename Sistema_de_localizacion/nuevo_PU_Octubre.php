...
<form id="form1" name="form1" method="post" action="">
  <table width="1123" border="0" align="center">
    <tr>
    ...
    <tr>
      ...
      <td height="17" colspan="4" rowspan="2"><div align="center"><img src="imagenes/abajo.JPG" width="36" height="31" /></div></td>
      <td rowspan="2">&nbsp;</td>
      <td colspan="3" rowspan="4"><table width="455" border="0" align="center">
        <tr>
          ...
          <td width="99" bgcolor="#0066FF"><div align="center" class="style27">
              <div align="center">Cuentas Trabajadas Octubre </div>
          </div></td>
          <td width="97" bgcolor="#0066FF"><div align="center"><span class="style28"><strong>Total Contactos Octubre </strong></span></div></td>
        </tr>
...
<div class="resultados" id="resultados"></div></td>
    ...
    <tr>
      ...
      <td width="113" bgcolor="#0033FF"><div align="center" class="style27">Producto</div></td>
      <td colspan="3" bgcolor="#0033FF"><div align="center" class="style27">Saldo</div></td>
      <td width="76" bgcolor="#0033FF"><div align="center" class="style27">Mora</div></td>
    ...
    <tr>
      ...
      <td width="46" bgcolor="#0066FF"><div align="center" class="style27">Tipo</div></td>
      <td><div align="center"></div></td>
    ...
    <tr>
      ...
      <td width="369" bgcolor="#FFFFFF">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="2" bgcolor="#FFFFFF"><input name="email_1" type="text" id="email_1" size="40" onblur="javascript:changeCase(this.form.email_1)" value=""/>
          <span class="style28"></span></td>
    </tr>
    <tr>
      <td width="17" bgcolor="#000099"><div align="center" class="style27">2- </div></td>
      <td width="21" bgcolor="#000099"><span class="style27">
      ...
      <td colspan="2" bgcolor="#FFFFFF"><input name="email_2" type="text" id="email_2" size="40" onblur="javascript:changeCase(this.form.email_2)" value=""/>
          <span class="style28"></span></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" bgcolor="#FFFFFF"><span class="style28"></span></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#FFFFFF"><span class="style28"></span><span class="style28"></span><span class="style28">
        <input name="centro" id="centro" value="<?php echo $fila_producto["centro"] ?>" size="30" readonly="true"/>
      </span></td>
      <td colspan="2" bgcolor="#FFFFFF"><div align="center"><span class="style4">
    ...
    <tr>
      <td><div align="center" class="style27">
        <input name="nombre"  id="nombre" size="1"  value="<?php /*Mostrando nombre de Usuario */echo $fila_observaciones["nombre"];?>" />
      </div></td>
