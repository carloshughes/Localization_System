...
.style41 {color: #0066FF; font-weight: bold; }
...
<form id="form1" name="form1" method="post" action="">
  <table width="1172" border="0" align="center">
    ...
    <tr>
      <td colspan="8"><div class="style43">
        <blockquote>
          <p align="center"><strong><?php echo $fila_observaciones["notas"] ?></strong></p>
        </blockquote>
      </div>      </td>
      <td rowspan="4">&nbsp;</td>
      <td rowspan="4">&nbsp;</td>
    ...
    <tr>
      <td height="74" colspan="5"><div align="center">
        <script src="ajax.js" language="javascript" type="text/javascript"></script>	  
      <span class="style41">No olviden buscar todos los numeros aqui </span></div></td>
      <td height="74"><img src="flecha.JPG" width="69" height="54" /></td>
      <td height="74" colspan="2"><div class="caja">
	     <div align="center">
...
<div class="resultados" id="resultados"></div></td>
      <td colspan="3"><table width="537" border="0" align="center">
        <tr>
          <td colspan="2" bgcolor="#000066"><div align="left" class="style27 style30">
              <div align="center">Cuentas Trabajadas al dia </div>
          </div></td>
          <td width="111" bgcolor="#000066"><div align="center"><strong><span class="style28">Contactos al dia </span></strong></div></td>
          <td width="135" bgcolor="#0066FF"><div align="center" class="style27">
              <div align="center">
                <p>Cuentas Trabajadas Octubre 2012 </p>
                </div>
          </div></td>
          <td width="154" bgcolor="#0066FF"><div align="center"><span class="style28"><strong>Contactos Realizados Octubre 2012 </strong></span></div></td>
        </tr>
        <tr>
          <td colspan="2"><div align="center" class="style31"><strong><?php echo $count_fecha['dia'];?></strong></div></td>
          <td><div align="center">
            <div align="center" class="style32"><?php echo $count_diarios['diarios'];?></div>
          </div></td>
          <td><div align="center" class="style27 style19"><?php echo $count['trabajadas'];?></div></td>
    ...
    <tr>
      ...
      <td width="111" bgcolor="#0033FF"><div align="center" class="style27">Mora</div></td>
    ...
    <tr>
      ...
      <td width="69" bgcolor="#0066FF"><div align="center" class="style27">CR</div></td>
      <td width="41" bgcolor="#0066FF"><div align="center" class="style27">Tipo</div></td>
      <td><div align="center"></div></td>
    ...
    <tr>
      ...
      <td width="14">&nbsp;</td>
      <td width="21" bgcolor="#000099"><div align="center" class="style27">
    ...
    <tr>
      ...
      <td width="36" bgcolor="#000099"><span class="style27">
    ...
    <tr>
      ...
      <td colspan="5" rowspan="2"><div align="center">
          <textarea name="observaciones" cols="45" id="observaciones" onblur="javascript:changeCase(this.form.observaciones)"></textarea>
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><input name="centro" id="centro" value="<?php echo $fila_producto["centro"] ?>" size="30" readonly="true" type="hidden"/></td>
      <td colspan="3">&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td><input name="nombre"  id="status_tel102" size="1"  value="<?php /*Mostrando nombre de Usuario */echo $fila_producto["nombre"];?>" type="hidden"/></td>
      <td>&nbsp;</td>
      ...
      <td width="117"><input name="cliente" id="cliente" value="<?php echo $fila_producto["cliente"] ?>" size="30" readonly="true" type="hidden"/></td>
      <td width="301"><input name="base" type="hidden" id="base" value="<?php echo $fila_producto["base"]?>"/></td>
    </tr>
  </table>
</form>
