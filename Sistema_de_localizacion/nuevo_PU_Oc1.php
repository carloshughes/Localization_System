...
<form id="form1" name="form1" method="post" action="">
  <table width="1001" border="0" align="center">
    ...
    <tr>
      <td height="17" colspan="5"><div align="center"><span class="style19">Entrada</span></div></td>
	  <?php 
...
?>
      ...
      <td colspan="2"><div align="center"></div></td>
        ...
        <tr>
          <td height="19" colspan="7" rowspan="3"><div align="center"><span class="style41">No olviden buscar todos y cada uno de los telefonos aqui </span></div></td>
          <td height="19" rowspan="3"><div align="center"><img src="imagenes/izquierda.JPG" width="25" height="31" /></div></td>
          <td height="19" colspan="4" rowspan="3"><script src="ajax.js" language="javascript" type="text/javascript"></script>
            <div class="caja">
              <div align="center">
                <input name="text" id="texto" onkeypress="Buscar();" size="30"/>
                
                </p>
              </div>
	    </div>
  <div class="resultados" id="resultados"></div></td>
          <td rowspan="3"><img src="imagenes/derecha.JPG" width="36" height="35" /></td>
          <td colspan="2"><div align="center">
