...
header("Location:Ejecutivo_nuevo_ctel.php");
		...
		//Consulta para saber cuantos Contactos lleva en el mes EN LA SEGUNDA VUELTA
		$sql_c_2 = "SELECT  count(*) contactos_2 FROM nueva_base_captura WHERE eslabon='".$_COOKIE["usuario_nombre"]."' and status_cuenta_2 ='CONTACTO'";
		$rs_c_2 = mysql_query($sql_c_2, $conexion);
		$count_c_2 = mysql_fetch_array($rs_c_2);
		
	
		$promedio_contactos = ($count_c['contactos']+$count_c_2['contactos_2']);

		//ver cuantas cuentas llevan dentro del mes
...
echo " <script language='JavaScript'>
					alert('La meta para este mes es del 23.5% de Localizados')
	              </script>";
...
<p align="center"><img src="imagenes/LOCALIZACION.JPG" width="443" height="247" /></p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="opcioneS_LB.JPG" width="799" height="564" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
<p><img src="bonos.JPG" width="2138" height="716" /></p>
<form id="form1" name="form1" method="post" action="">
  <table width="967" border="0" align="center">
    ...
    <tr>
      ...
      <td colspan="2"><div align="center">
        ...
        <tr>
          ...
          <td height="4" colspan="2" bgcolor="#0066FF"><div align="center" class="style28"><strong>CONTACTADO POR </strong></div></td>
    </tr>
        <tr>
          ...
          <td height="9" colspan="2"><div align="center">
            <select name="medio" id="medio">
              ...
              <option>CYBER</option>
              <option>IG</option>
              <option>Seccion Amarilla</option>
              <option>Call Manager</option>
              <option>Telefonos de Call Center</option>
            </select>
          </div></td>
        </tr>
    ...
    <tr>
      ...
      <td width="47" bgcolor="#0033FF"><div align="center" class="style27">Mora</div></td>
      <td width="378" bgcolor="#0033FF"><div align="center" class="style27">Ciclo</div>        <div align="center"></div></td>
    </tr>
    <tr>
      <td colspan="3"><div align="center">
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#0066FF"><div align="center" class="style27">CA</div></td>
      <td width="60" bgcolor="#0066FF"><div align="center" class="style27">CR</div></td>
      <td width="90" bgcolor="#0066FF"><div align="center" class="style27">Tipo</div></td>
    ...
    <tr>
      <td colspan="2" bgcolor="#000099"><div align="center" class="style27">2- </div></td>
      <td width="85"><div align="center">
				  <script src="ajaxt1.js" language="javascript" type="text/javascript"></script>
            <div class="caja">

              <div align="left">
                <input name="telefono_2" type="text"id="telefono_2" onkeypress="Buscarb(), mis_datos();" value="<?php echo $fila_producto["telefono_2"] ?>" size="13" maxlength="13" />
              </div>
    ...
    <tr>
      <td colspan="2" bgcolor="#0000CC"><div align="center" class="style27">3-</div></td>
      <td><div align="center">
		  <script src="ajaxt1.js" language="javascript" type="text/javascript"></script>
            <div class="caja">

              <div align="left">
                <input name="telefono_3" type="text"id="telefono_3" onkeypress="Buscarc(), mis_datos();" value="<?php echo $fila_producto["telefono_3"] ?>" size="13" maxlength="13"/>
              </div>
    ...
    <tr>
      <td colspan="2" bgcolor="#0000FF"><div align="center" class="style27">4-</div></td>
      <td><div align="center">
		  <script src="ajaxt1.js" language="javascript" type="text/javascript"></script>
            <div class="caja">

              <div align="left">
                <input name="telefono_4" type="text"id="telefono_4" onkeypress="Buscard(), mis_datos();" value="<?php echo $fila_producto["telefono_4"] ?>" size="13" maxlength="13"/>
              </div>
    ...
    <tr>
      <td colspan="2" bgcolor="#0066FF"><div align="center" class="style28"><strong>5-</strong></div></td>
      <td><div align="center">
		  <script src="ajaxt1.js" language="javascript" type="text/javascript"></script>
            <div class="caja">

              <div align="left">
                <input name="telefono_5" type="text"id="telefono_5" onkeypress="Buscare(), mis_datos();" value="<?php echo $fila_producto["telefono_5"] ?>" size="13" maxlength="13" />
              </div>
    ...
    <tr>
      <td colspan="2" bgcolor="#0066FF"><div align="center" class="style27">6-</div></td>
      <td><div align="center">
		  		  <script src="ajaxt1.js" language="javascript" type="text/javascript"></script>
            <div class="caja">

              <div align="left">
                <input name="telefono_6" type="text"id="telefono_6" onkeypress="Buscarf(), mis_datos();" value="<?php echo $fila_producto["telefono_6"] ?>" size="13" maxlength="13" />
              </div>
    ...
    <tr>
      <td height="24" colspan="2" bgcolor="#0000FF"><div align="center" class="style27">7-</div></td>
      <td><div align="center">
		  		  <script src="ajaxt1.js" language="javascript" type="text/javascript"></script>
            <div class="caja">

              <div align="left">
                <input name="telefono_7" type="text"id="telefono_7" onkeypress="Buscarg(), mis_datos();" value="<?php echo $fila_producto["telefono_7"] ?>" size="13" maxlength="13" />
              </div>
    ...
    <tr>
      <td colspan="2" rowspan="2" bgcolor="#0000CC"><div align="center" class="style27">8-</div></td>
      <td rowspan="2"><div align="center">
		  		  <script src="ajaxt1.js" language="javascript" type="text/javascript"></script>
            <div class="caja">

              <div align="left">
                <input name="telefono_8" type="text"id="telefono_8" onkeypress="Buscarh(), mis_datos();" value="<?php echo $fila_producto["telefono_8"] ?>" size="13" maxlength="13" />
              </div>
      ...
      <td colspan="2" rowspan="5"><table width="429" border="0" align="center">
        <tr>
    ...
    <tr>
      <td colspan="3" bgcolor="#FFFFFF"><input name="status_tel9"  id="status_tel9" size="1" type="hidden" />
        <span class="style28">
        <input name="cliente" id="cliente" value="<?php echo $fila_producto["cliente"] ?>" size="30" readonly="true" type="hidden"/>
      </span></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#000099"><div align="center" class="style27">9-</div></td>
      <td><div align="center">
		  		  <script src="ajaxt1.js" language="javascript" type="text/javascript"></script>
            <div class="caja">

              <div align="left">
                <input name="telefono_9" type="text"id="telefono_9" onkeypress="Buscari(), mis_datos();" value="<?php echo $fila_producto["telefono_9"] ?>" size="13" maxlength="13" />
              </div>
      ...
      <td colspan="3" bgcolor="#FFFFFF"><span class="style28"></span><span class="style28"><span class="style31">
        <input name="status_tel10"  id="status_tel10" size="1" type="hidden"/>
      </span></span></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#000066"><div align="center" class="style27">10</div></td>
      <td><div align="center">
		  		  <script src="ajaxt1.js" language="javascript" type="text/javascript"></script>
            <div class="caja">

              <div align="left">
                <input name="telefono_10" type="text"id="telefono_10" onkeypress="Buscarj(), mis_datos();" value="<?php echo $fila_producto["telefono_10"] ?>" size="13" maxlength="13"/>
              </div>
    ...
    <tr>
      <td width="17"><div align="center" class="style27">
        <input name="nombre"  id="nombre" size="1"  value="<?php /*Mostrando nombre de Usuario */echo $fila_observaciones["nombre"];?>" type="hidden"/>
      </div></td>
      <td width="20"><?php $fecha = date ("Y-m-d");?></td>
      <td><div align="center">
        <input name="hora" size="6" readonly="true" value="horaImprimible"/>
      </div></td>
      <td width="17"><input name="fecha"  id="fecha" size="8" value="<?php echo $fecha;?>" readonly="true" type="hidden"/></td>
      <td width="38">&nbsp;</td>
      <td width="19"><input name="eslabon"  id="eslabon" value="<?php echo $fila_observaciones["usuario"] ?>" size="30" readonly="true" type="hidden"/></td>
      <td width="93"><input name="gestion"  id="gestion" value=" " size="30" readonly="true" type="hidden"/></td>
      <td width="50"><input name="turno"  id="turno" value="<?php echo $fila_observaciones["turno"] ?>" size="30" readonly="true" type="hidden"/></td>
...
//VALIDANDO QUE SE INDIQUE POR QUE MEDIO SE CONTACTO LA CUENTA
...
msg.document.write("<center><img src='imagenes/directorio3.JPG' onblur=window.close()> </center>");
...
var texto="RECUERDA QUE LA META ES DEL 19% "
texto=texto.split("")
