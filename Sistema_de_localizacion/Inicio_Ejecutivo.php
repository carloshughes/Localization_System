...
<p align="center">&nbsp;</p>
<form id="form2" name="form2" method="post" action="verificasesion.php">
  <center>
...
<table width="54%" height="34%" border="0" align="center" bordercolor="#003399">
                  ...
                  <tr>
                    <td width="61%" rowspan="7" bordercolor="0"><div align="center"><img src="imagenes/logo1.jpg" width="266" height="209" /></div></td>
                    <td height="20%" colspan="2" bordercolor="0"><div align="left"><span class="style42">iniciar  sesi&oacute;n</span></div></td>
                    <td width="5%" rowspan="9" bordercolor="0"><p align="center">&nbsp;</p>
                    <p align="center">&nbsp;</p></td>
                  </tr>
              <tr>
                <td width="10%" height="20%" bordercolor="0"><div align="left" class="style40"></div></td>
                <td width="24%" bordercolor="0"><div align="center"></div></td>
              </tr>
              
            
              <tr>
                <td height="59%" bordercolor="0"><span class="style40"><font color="#FFFFFF"><font color ="#084B8A">Usuario:</font></font></span></td>
                <td bordercolor="0"><font color="#FFFFFF">
                  <input name="usuario" type="text" id="usuario" onBlur="javascript:sText(this);" onClick="javascript:sText(this);" value="Ingresa tu eslabon" size="25" maxlength="25" />
                </font></td>
              </tr>
              <tr>
...
<script language="JavaScript">
    function sText( sObj ){
      if( sObj.value.length == 0 ){
        sObj.value = "Ingresa tu eslabon"
      }else if( sObj.value == "Ingresa tu eslabon" ){
        sObj.value = "";
      }
    }
</script>