...
//conectano a la pagina verificasession.php para comprobar si la session ha sido empezada
...
header("Location:Ejecutivo_nuevo_sa.php");
...
<p align="center"><img src="sa.jpg" width="488" height="488" /></p>
  ...
  <table width="1001" border="0" align="center">
    ...
    <tr>
      <td colspan="13"><div align="center">
        <p><strong>Cuenta buscada en SA sin datos obtenidos </strong></p>
        </div></td>
    ...
    <tr>
      <td height="17" colspan="5"><div align="center"><span class="style19"><strong>Entrada</strong></span></div></td>
	  <?php 
      ...
      <td height="17" colspan="6" rowspan="2"><p align="center" class="style43">&nbsp;</p></td>
      <td colspan="2"><div align="center">
    ...
    <tr>
      <td height="6" colspan="5"><div align="center"></div></td>
      <td height="6" colspan="2"><div align="center"><span class="style43"><?php echo $fila["hora"]?>
          <?php
}
?>
      </span></div></td>
      <td colspan="2"><div align="center" class="style28"></div></td>
    </tr>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td colspan="2" bgcolor="#0066FF"><div align="center" class="style28"><strong>CONTACTADO POR </strong></div></td>
        </tr>
        <tr>
          <td height="2" colspan="7">&nbsp;</td>
          <td height="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="3"><span class="style28"></span><span class="style28"></span></td>
      <td colspan="2">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="3"><span class="style28"></span><span class="style28"></span><span class="style28"></span></td>
      <td colspan="2">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3"><span class="style28">
    ...
    <tr>
      ...
      <td colspan="3"><span class="style28"></span><span class="style28"></span><span class="style28">
    ...
    <tr>
      ...
      <td colspan="3"><span class="style28"></span><span class="style28">
    ...
    <tr>
      ...
      <td><input name="gestion"  id="gestion" value="<?php echo $fila_producto["gestion"] ?>" size="30" readonly="true"/></td>
