...
if (($_POST["status_tel1"]=='PC') || ($_POST["status_tel2"]!='C') || ($_POST["status_tel3"]!='C') || ($_POST["status_tel4"]!='C') || ($_POST["status_tel5"]!='C') || ($_POST["status_tel6"]!='C') || ($_POST["status_tel7"]!='C') || ($_POST["status_tel8"]!='C') || ($_POST["status_tel9"]!='C') || ($_POST["status_tel10"]!='C')){
  mysql_query("UPDATE nueva_base_captura SET status_cuenta_2= 'POSIBLE CONTACTO' WHERE cuenta=" .$_REQUEST["cod"].";",$conexion);
...
if (($_POST["status_tel1"]=='C') || ($_POST["status_tel2"]=='C') || ($_POST["status_tel3"]=='C') || ($_POST["status_tel4"]=='C') || ($_POST["status_tel5"]=='C') || ($_POST["status_tel6"]=='C') || ($_POST["status_tel7"]=='C') || ($_POST["status_tel8"]=='C') || ($_POST["status_tel9"]=='C') || ($_POST["status_tel10"]=='C')){
  mysql_query("UPDATE nueva_base_captura SET status_cuenta_2= 'CONTACTO' WHERE cuenta=" .$_REQUEST["cod"].";",$conexion);
...
if (($_POST["status_tel1"]=='IL') && ($_POST["status_tel2"]=='IL') && ($_POST["status_tel3"]=='IL') && ($_POST["status_tel4"]=='IL') && ($_POST["status_tel5"]=='IL') && ($_POST["status_tel6"]=='IL') && ($_POST["status_tel7"]=='IL') && ($_POST["status_tel8"]=='IL') && ($_POST["status_tel9"]=='IL') && ($_POST["status_tel10"]=='IL')){
  mysql_query("UPDATE nueva_base_captura SET status_cuenta_2= 'ILOCALIZABLE' WHERE cuenta=" .$_REQUEST["cod"].";",$conexion);
}



//REDIRECCIONANDO A LA PAGINA Ejecutivo UNA VEZ REALIZANDO LA CAPTURA DE LA CUENTA
header("Location:buscar_cuentas.php");
...
<p align="center" class="style48">&nbsp;</p>
...
?>
      ...
      <td colspan="2"><div align="center"></div></td>
        ...
        <tr>
          <td height="19" colspan="7" rowspan="2">&nbsp;</td>
          <td height="19" rowspan="2">&nbsp;</td>
          <td height="19" colspan="4" rowspan="2">&nbsp;</td>
          <td rowspan="2">&nbsp;</td>
      <td colspan="2"><div align="center" class="style28"><strong>CONTACTADO POR </strong></div></td>
    </tr>
        <tr>
          <td colspan="2"><div align="center"></div></td>
        </tr>
      ...
      <td colspan="2" rowspan="4"><table width="429" border="0" align="center">
        <tr>
          ...
          <td width="99" bgcolor="#0066FF"><div align="center" class="style27">
              <div align="center">Cuentas Trabajadas Enero </div>
          </div></td>
          <td width="71" bgcolor="#880000"><div align="center">
            <p class="style28"><strong>TOTAL CONTACTOS CON REMARCACION</strong></p>
            </div></td>
          <td width="71" bgcolor="#0066FF"><div align="center"><span class="style28"><strong>Total Contactos Enero </strong></span></div></td>
        </tr>
        <tr>
          ...
          <td><div align="center" class="style27 style47"><?php echo $count['trabajadas'];?></div>              </td>
          <td><div align="center"><span class="style47"><?php echo $promedio_contactos; ?></span></div></td>
          <td><div align="center" class="style47"><strong><?php echo $count_c['contactos'];?></strong></div></td>
        </tr>
      </table></td>
    </tr>
    <tr>
