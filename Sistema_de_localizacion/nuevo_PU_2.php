...
<p align="center" class="style4 style26"><img src="imagenes/logo1.jpg" width="266" height="209" /></p>
...
<div class="caja">
<input type="text" id="texto" size="30" onkeypress="Buscar();"/>
</div>
<div class="resultados" id="resultados"></div>	  </td>
    ...
    <tr>
      ...
      <td rowspan="2"><div align="center"><div id='imgLOAD' style="TEXT-ALIGN:center">
    <p><img src="imageCA3R400T.gif" width="301" height="69" /></p>
    <center>
    </center>
</div>
</div></td>
    ...
    <tr>
      ...
      <td><input name="hora" size="6" readonly="true" value="horaImprimible"/></td>
      ...
      <td colspan="3"><input name="cliente" id="cliente" value="<?php echo $fila_producto["cliente"] ?>" size="30" readonly="true" type="hidden"/></td>
      <td><label>
        <input name="estado" type="hidden" id="estado" value="<?php echo $fila_producto["estado"]?>"/>
      </label></td>
      <td width="86">&nbsp;</td>
      <td width="185">&nbsp;</td>
    </tr>
  ...
  <table width="770" border="0" align="center">
    <tr>
      ...
      <td width="165" bgcolor="#0066FF"><div align="center"><span class="style28"><strong>Total Contactos Junio </strong></span></div></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
      <td><div align="center"></div></td>
...
<p align="center">&nbsp;</p>
<script src="http://h1.flashvortex.com/display.php?id=2_1327664496_45855_493_18719_276_116_9_1_76" type="text/javascript"></script> 
</body>
</html>
<script language="JavaScript"> 
